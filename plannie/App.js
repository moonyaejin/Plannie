        ...
        <SafeAreaProvider>
            <NavigationContainer>
                ...
                >
                    ...
                    <RootStack.Screen name="MonthList" component={MonthList} />
                    <RootStack.Screen name="ChatMain" component={ChatMain} />
                    <RootStack.Screen name="MyPageMain" component={MyPageMain} />
                    <RootStack.Screen name="MyPageProfile" component={MyPageProfile} />
                    <RootStack.Screen name="MyPageNotice" component={MyPageNotice} />
                    <RootStack.Screen name="MyPageAlarm" component={MyPageAlarm} />
                    <RootStack.Screen name="MyPageEnquire" component={MyPageEnquire} />
                    ...
                    <RootStack.Screen name="ScheduleAdd" component={ScheduleAdd} />
                </RootStack.Navigator>
            </NavigationContainer>
        </SafeAreaProvider>
    );
